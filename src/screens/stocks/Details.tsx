    ...
    <View>
      <View style={styles.flexRowBetween}>
        ...
        <View style={styles.flexRow}>
          <MaterialIcons  name="access-alarm" color={colors.primary} size={RFValue(18)} />
          <Ionicons
            name="bookmark-outline"
            color={colors.primary}
            size={RFValue(18)}
          />
          <Ionicons name="search" color={colors.primary} size={RFValue(18)} />
        </View>
      </View>
      ...
      <View style={styles.flexRowBetween}>
        ...
        >
          <Ionicons name="link" color={colors.primary} size={RFValue(12)} />
          <CustomText
            variant="h9"
            fontSize={8}
            fontFamily={FONTS.Medium}
